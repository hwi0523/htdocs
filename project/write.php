...
<head>
    ...
    <title>레시피작성</title>
    <link rel="stylesheet" href="/project/css/css2.css">
</head>
<body>
<?php
...
?>
    <main>
        <div class="main">
            <form action="write_proc" method="post" enctype="multipart/form-data">
                <div>
                    <label>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <select name="category" id="category">
                            ...
                            <option value="0">양식</option>
                            <option value="0">일식</option>
                            <option value="0">중식</option>
                        </select>
                    </div>
                    <div>
                        <label for="ctnt">내용 </label>
                        <textarea name="ctnt" id="ctnt" cols="30" rows="20"></textarea>
                    </div>
                    <div>
